...
\begin{document}
	...
	The performance of the final model on the test data from QTR1 2019 is displayed in table  REFERENCE. The corresponding confusion matrix is shown in table REFERENCE and the class-wise precision is shown in table REFERENCE. Recall that the final model is the default CatBoost classifier with tf-idf vectorization using 0.001 for \lstinline{min_df} and 0.9 for \lstinline{max_df}.
